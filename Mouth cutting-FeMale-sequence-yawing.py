...
videos_path1="E:/data/YawDD/YawDD dataset/Mirror-Table1/Yawing/"
...
#                        cv2.circle(frame, (x, y_66), 6, (0, 0, 0), -1)
                        ...
                        if abs(y_62 - y_66)>13:
                            if framecount%2==0:
                                    countimg+=1
                                    framedeep=frame[y_66-60:y_66+60, x-60:x+50]
                                    framedeep = cv2.cvtColor(framedeep, cv2.COLOR_BGR2GRAY)
                                    framedeepequ=cv2.equalizeHist(framedeep)
                                    name ="%d.bmp"%(countimg)
                                    filename="E:/data/YawDD/YawDD dataset/Mirror-Table1/Female-Yawing/"+name
